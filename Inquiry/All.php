  ...
  <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="d-flex align-items-end row">
            ...
            <div class="col-sm-5 text-center text-sm-left">
              <div class="card-body pb-0 px-0 px-md-4">
                <img src="<?= SYSTEM_PATH_BACKEND ?>assets/img/illustrations/man-with-laptop-light.png" height="140"
    ...
    <div class="row">
      <div class="col-12 mb-4">
        ...
        <div class="card">
          <?php
           $sqlInquirie = "SELECT * FROM inquiries ORDER by Loggeddate DESC;";
          $db = dbConn();
          $resultInquirie = $db->query($sqlInquirie);
          $rowInquirie = $resultInquirie->fetch_assoc();
           $statusofInquiry = $rowInquirie['InquiresState'];
          ...
          <div class="table-responsive text-nowrap">
            <table class="table">
              ...
              <tbody class="table-border-bottom-0">
                ...
                <?php
                $sqlInquiries = "SELECT * FROM inquiries ORDER by Loggeddate DESC;";
                $db = dbConn();
